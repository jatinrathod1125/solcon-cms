...
@section('title', 'Edit Grout Formula')
@section('header-title', 'Edit Grout Formula')
...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <div class="bg-slate-950 border border-slate-850 rounded-2xl shadow-xl p-6 md:p-8">
        <h3 class="text-lg font-bold text-white mb-6">Edit Grout Formula version #{{ $formula->version }}</h3>

        <form method="POST" action="{{ route('admin.grout-formulas.update', $formula) }}" class="space-y-6" id="formula-form">
            @csrf
            @method('PUT')
