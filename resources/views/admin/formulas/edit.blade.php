...
<script>
    $(document).ready(function() {
        ...
        // If editing a formula, pre-select brand matching formula's grade brand if brand_id not already set
        @if(isset($formula) && $formula->grade && $formula->grade->brand_id)
            if (!$('#brand_id').val()) {
                $('#brand_id').val("{{ $formula->grade->brand_id }}");
            }
        @endif
