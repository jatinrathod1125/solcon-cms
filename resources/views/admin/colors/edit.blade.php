...
@section('title', 'Edit Grout Color')
@section('header-title', 'Edit Grout Color')
...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="bg-slate-950 border border-slate-850 rounded-2xl shadow-xl p-6 md:p-8">
        <h3 class="text-lg font-bold text-white mb-6">Edit Grout Color Details</h3>

        <!-- Form -->
        <form method="POST" action="{{ route('admin.grout-colors.update', $color) }}" class="space-y-6">
            @csrf
            @method('PUT')
