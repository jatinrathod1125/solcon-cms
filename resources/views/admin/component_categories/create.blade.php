...
@section('title', 'Add Component Category')
@section('header-title', 'Create Component Category')
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="bg-slate-950 border border-slate-850 rounded-2xl shadow-xl p-6 md:p-8">
        <h3 class="text-lg font-bold text-white mb-6">Component Category Details</h3>

        <!-- Form -->
        <form method="POST" action="{{ route('admin.component-categories.store') }}" class="space-y-6">
            @csrf
