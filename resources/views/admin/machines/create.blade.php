...
@section('header-title', 'Create Machine')
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="bg-slate-950 border border-slate-850 rounded-2xl shadow-xl p-6 md:p-8">
        <h3 class="text-lg font-bold text-white mb-6">Machine Details</h3>

        <!-- Form -->
        <form method="POST" action="{{ route('admin.machines.store') }}" class="space-y-6">
            @csrf
