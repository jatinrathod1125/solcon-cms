...
class MarketingOrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'items.*.coupon_raw_material_id' => 'nullable|exists:raw_materials,id',
    ...
    {
        $order->load(['items.grade', 'items.color', 'items.epoxyProduct', 'items.couponMaterial', 'creator', 'approver']);
        
        // Dynamic product and coupon details
